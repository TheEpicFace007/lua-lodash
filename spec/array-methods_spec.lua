...
describe('"Arrays" category methods', function ()
  ...
  describe("accept falsy primary arguments", function ()
    it("#difference", function ()
      assert.are.same(_.difference(nil, array), {})
    end)
    it("#intersection", function () 
      assert.are.same(_.intersection(nil, array), {})
    end)
    it("#union", function ()
      assert.are.same(_.union(nil, array), array)
    end)
    it("#xor", function ()
      assert.are.same(_.xor(nil, array), array)
    end)
  end)
  
  describe("accept falsy secondary arguments", function ()
    it("#difference", function ()
      assert.are.same(_.difference(array, nil), array)
    end)
    it("#intersection", function () 
      assert.are.same(_.intersection(array, nil), {})
    end)
    it("#union", function ()
      assert.are.same(_.union(array, nil), array)
    end)
  end)
end)